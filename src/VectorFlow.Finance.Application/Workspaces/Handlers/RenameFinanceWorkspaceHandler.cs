...
public sealed class RenameFinanceWorkspaceHandler
{
    private readonly IFinanceWorkspaceRepository _repository;
    private readonly IClock _clock;

    public RenameFinanceWorkspaceHandler(IFinanceWorkspaceRepository repository, IClock clock)
    {
    ...
    public async Task<ApplicationResult<FinanceWorkspaceDto>> HandleAsync(
        RenameFinanceWorkspaceCommand command,
