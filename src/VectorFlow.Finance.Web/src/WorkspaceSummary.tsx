...
export function WorkspaceSummary({ workspace, onNavigate }: WorkspaceSummaryProps) {
  ...
  const loadTotals = useCallback(async (workspaceId: string) => {
