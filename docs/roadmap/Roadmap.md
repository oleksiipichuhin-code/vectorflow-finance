...
| F4I | Accrual HTTP Surface | Complete locally / awaiting publication |
| F4J+ | Later invoice listing/query and remaining Accrual enhancements | Planned |

F4A–F4H are published. F4I Accrual HTTP Surface is complete in the working tree until separately published. Later invoice listing/query and remaining Accrual enhancements remain planned. F4 as a whole remains incomplete.
