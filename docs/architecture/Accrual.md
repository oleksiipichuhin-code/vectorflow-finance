...
- `UpdatedAt` is included because mutable Domain aggregates use it with monotonic timestamp checks, and Accrual persistence uses it as the optimistic concurrency token.
